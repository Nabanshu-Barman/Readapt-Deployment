...
/* Root primitives (Radix root & composite) */
...
>(({ ...props }, ref) => (
  // Radix Portal itself does not expose the ref to a DOM element,
  // but forwardRef keeps Radix SlotClone from warning.
...
/* Header / Footer (plain divs; no ref needed, but we can forward for parity) */
